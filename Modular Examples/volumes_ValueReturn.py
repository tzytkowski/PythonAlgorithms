...
def main():
    ...
    while choice != "e":
        if choice == "c":
            VolCube = CalculateCube()
            #print cube to the user
            print("The volume is:  ", VolCube)
        elif choice == "r":
            VolRect = CalculateRectangle()
            #print out volume to the user
            print("The volume is:  ", VolRect)

        else:
            VolSphere = CalculateSphere()
            #print out volume to the user
            print("The volume is:  ", VolSphere)
        #end if
        displayMenu()
        choice = input("Enter your choice:")
    #End while
